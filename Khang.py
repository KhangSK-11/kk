...
#Hàm reset game
def reset_game():
    global score, game_over, spaceship, chuanbi
...
def check_ship_selection():
    global spaceship, Chọn, can_select, chuanbi
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if Chọn is not None:
                ...
                chuanbi = False  # Chưa sàng bắt đầu game
                print("Chọn xong nhân vật!")
                break

def gameplay():
    global running, game_over, chuanbi, can_select
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE and (game_over or chuanbi):
                    reset_game()  # ấn cách để bắt đầu game hoặc chơi lại
        
        #Bắt đầu game
        if not game_over and not chuanbi:
